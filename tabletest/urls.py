...
urlpatterns = [
    ...
    path('modal_file_showdelete/<int:orderid>/', FileShowDeleteFormView.as_view(), name='modal_file_showdelete'),
    path('modal_file_showonly/<int:orderid>/', FileShowOnlyFormView.as_view(), name='modal_file_showonly'),
